        ...
        <div>
          <GridContainer>
            <GridItem xs={12} sm={12} md={4}>
              <Card plain>
                <GridItem xs={12} sm={12} md={6} className={classes.itemGrid}>
                  <a href="https://hsdeckbuilder.herokuapp.com"><img src={hearthstonepic} alt="hearthstone" className={imageClasses} /></a>
                </GridItem>
            ...
            <GridItem xs={12} sm={12} md={4}>
              <Card plain>
                <GridItem xs={12} sm={12} md={6} className={classes.itemGrid}>
                  <Link to="/hangman"><img src={hangmanpic} alt="hangman" className={imageClasses} /></Link>
                </GridItem>
                <h4 className={classes.cardTitle}>
                  Word Guessing Game
                  <br />
            ...
            <GridItem xs={12} sm={12} md={4}>
              <Card plain>
                <GridItem xs={12} sm={12} md={6} className={classes.itemGrid}>
                  <Link to="/giphy"><img src={giphypic} alt="giphy" className={imageClasses} /></Link>
                </GridItem>
                <h4 className={classes.cardTitle}>
                  Giphy
                  <br />
            ...
            <GridItem xs={12} sm={12} md={4}>
              <Card plain>
                <GridItem xs={12} sm={12} md={6} className={classes.itemGrid}>
                  <Link to="/starwars"><img src={starwarspic} alt="starwars" className={imageClasses} /></Link>
                </GridItem>
                <h4 className={classes.cardTitle}>
                  Star Wars
                  <br />
            ...
            <GridItem xs={12} sm={12} md={4}>
              <Card plain>
                <GridItem xs={12} sm={12} md={6} className={classes.itemGrid}>
                  <Link to="/rps"><img src={rpspic} alt="rock paper scissors" className={imageClasses} /></Link>
                </GridItem>
                <h4 className={classes.cardTitle}>
            ...
            <GridItem xs={12} sm={12} md={4}>
              <Card plain>
                <GridItem xs={12} sm={12} md={6} className={classes.itemGrid}>
                  <a href="https://github.com/picholasnaridon/Liri"><img src={liripic} alt="liri pic" className={imageClasses} /></a>
                </GridItem>
                <h4 className={classes.cardTitle}>
                  Liri
                  <br />
            ...
            <GridItem xs={12} sm={12} md={4}>
              <Card plain>
                <GridItem xs={12} sm={12} md={6} className={classes.itemGrid}>
                  <a href="https://bestfriendsforever123.herokuapp.com/"><img src={friendfinderpic} alt="friend pic" className={imageClasses} /></a>
                </GridItem>
                <h4 className={classes.cardTitle}>
                  Friend Zone
                  <br />
                ...
                <CardBody>
                  <p className={classes.description}>
                    Node app built using Express and Handlebars. Allows users to find their true love!
                  </p>
                </CardBody>
                <CardFooter className={classes.justifyCenter}>
                  <Button
            ...
            <GridItem xs={12} sm={12} md={4}>
              <Card plain>
                <GridItem xs={12} sm={12} md={6} className={classes.itemGrid}>
                  <a href="https://thehamburgler.herokuapp.com/"><img src={burgerSQL} alt="friend pic" className={imageClasses} /></a>
                </GridItem>
                <h4 className={classes.cardTitle}>
                  Node + Sequelize
                  <br />
            ...
            <GridItem xs={12} sm={12} md={4}>
              <Card plain>
                <GridItem xs={12} sm={12} md={6} className={classes.itemGrid}>
                  <a href="https://savethedate.herokuapp.com/"><img src={savethedate} alt="friend pic" className={imageClasses} /></a>
                </GridItem>
                <h4 className={classes.cardTitle}>
                  Save the Date
                  <br />
                ...
                <CardBody>
                  <p className={classes.description}>
                    Node app with a MySQL backend that uses the Twilio API to get you out of a bad date. Uses Passport for user authentication.
                  </p>
                </CardBody>
                <CardFooter className={classes.justifyCenter}>
                  <Button
